        ...
        <div>
            <div className='md:flex md:justify-between items-center px-8 md:px-24 md:gap-28 bg-blue-100'>
                <div className=''>
                    ...
                    <p className='my-3 md:my-7'>Explore thousands of job opportunities with all the <br /> information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
